    ...
    <div style="background-color: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <div style="text-align: center; padding-bottom: 15px; border-bottom: 2px solid #e9ecef;">
            ...
            <p style="margin: 0; font-size: 14px;">
                <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://khanakyabanau.in'}?utm_source=email&utm_medium=email&utm_campaign=meal_plan" style="color: #007bff; text-decoration: none; font-weight: 500;">🔗 Open https://khanakyabanau.in</a>
            </p>
        </div>
        ...
        <div style="text-align: center; padding-top: 16px; border-top: 1px solid #e9ecef; color: #6c757d; font-size: 14px;">
            ...
            <p style="margin: 0 0 12px 0;">
                <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://khanakyabanau.in'}?utm_source=email&utm_medium=email&utm_campaign=meal_plan_footer" style="color: #007bff; text-decoration: none;">Visit your meal planner</a> 
